...
async def start(_, msg):
    buttons = [
        ...
        [
          InlineKeyboardButton("𝗦𝗨𝗣𝗣𝗢𝗥𝗧", url="https://t.me/DevilxDiscuss "),
          InlineKeyboardButton("𝗢𝗪𝗡𝗘𝗥", url="https://t.me/Monu_Gupta_01"),
          ],
               [
                InlineKeyboardButton("𝗨𝗣𝗗𝗔𝗧𝗘𝗦", url="https://t.me/Devil_World_01"),
